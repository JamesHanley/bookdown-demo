...
**Distribution of particles in volumes**
...
**Distribution of events in time intervals**
...
The following is meant to look like the marks on a 5-minute strip on the paper tape described by Rutherford. 
...
https://www.jstor.org/stable/1403193?seq=1


```{r,eval=T, echo=F, fig.align="center", fig.height=7.5, fig.width=9, warning=FALSE, message=F,fig.cap="Section 12 of Bortkewitsch1898 book on the Poisson Distribution."}


knitr::include_graphics('images/Bortkewitsch1898section12.jpg')
