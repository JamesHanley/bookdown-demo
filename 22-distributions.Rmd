...
plot.sum2rvs = function(v){
   CEX=1.1
   par(mfrow=c(1,1),mar = rep(0,4))
   plot(-10,-10,xlim=c(-5,40),ylim=c(-0.10,1),
     xaxt="n",yaxt="n",frame=TRUE)
   ...
   for(i in seq(0,28,1)){
        ...
        text(i,y0-0.01,toString(i),cex=CEX/1.5,adj=c(0.5,1))
   }
   ...
   for (rv1.v in 1:2){
   	   ...
   	   txt = bquote(frac(1, 2))
         text(-0.5,y, txt,cex=CEX/1.5, adj=c(1,0.5))
   	   segments(0, y , v[rv1.v,1], y)
   	   points(v[rv1.v,1], y,  pch=19,cex=0.5 )
   	   txt1 = toString(v[rv1.v,1] - MEAN)
   	   if(rv1.v==2) txt1 = paste("+",txt1,sep="")
   	   #text(v[rv1.v,1], y, txt,adj=c(0.5,1.35))
   	   Mean = mean(v[,2])
   	   for (rv2.v in 1:2){
   	      yy = y + DY[2] * (rv2.v - 1.5)
   	      txt = bquote(frac(1, 2))
            text(v[rv1.v,1]-0.5,yy, txt,cex=CEX/1.5, adj=c(1,0.5))
   	      segments(v[rv1.v,1],               yy , 
   	               v[rv1.v,1]  + v[rv2.v,2], yy )
   	      points(v[rv1.v,1]  + v[rv2.v,2], yy, 
   	             pch=19,cex=0.9 )
   	      points(v[rv1.v,1]  + v[rv2.v,2], y0+0.065, 
   	             pch=19,cex=0.9 )
   	      txt2 = toString(v[rv2.v,2] - Mean)
   	   if(rv2.v==2) txt2 = paste("+",txt2,sep="")
       ...
       if(rv1.v==2 & rv2.v ==2) Txt = 
            bquote((+3)^2 + (+4)^2 + 2(+3)(+4) )       
       text(41, yy-0.035, Txt,adj=c(1,0.5))

       }
   }
   text(41,1,"The Squared Deviations",adj=c(1,1))
   arrows(0, y0+0.065, 13, y0+0.065,length=0.06,angle=25 )
   text(0, y0+0.065, "Sum of 2\nrandom variables",adj=c(0,0.5) )
   
   text(41, y0+0.08, "====================" ,adj=c(1,0.5))
   
   text(31, y0+0.02, 
        bquote(3^2 ~  ~ + ~  ~ 4^2), adj=c(0,0.5),cex=1.5)
   text(31.25, y0-0.05,"VAR[Sum]", adj=c(0,0.5))
