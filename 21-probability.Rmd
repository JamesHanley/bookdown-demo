...
John Snow, cholera deaths Soutrh London, by source of drinking water
...
1. Convert the proportion of males born to a sex ratio, and to the log of the sex ratio. If, because of natural year to year variations, the proportion varies from 0.49 to 0.53, what does the ratio from from? the log of the ratio?  What if proportion were 3/4. scales SDs See John Arbuthnot's data.
