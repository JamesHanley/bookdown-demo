...
for( year in max(ds$Year) ) {
 for( g in unique(ds$Gender) ) {
  ...
  text(250,-10, "Rank",adj=c(0.5,1),cex=1,col=COL)
  ...
  for (i.row in 1:50){
     ...
     text(485,max(d$Frequency)-dy*i.row,
          paste(toString(sum), "", 
      ...
      text(505,max(d$Frequency)-dy*i.row,
  ...
  y = 3.5*dy
  text(430,y,"Across the 50 Rows:",adj=c(1,0),
       family="mono", cex=CEX, font = 4,col=COL)
  
  y=2.5*dy
  text(505,y,format(round(mean(S[,2]),1),nsmall=1),adj=c(0.35,0),
       family="mono", cex=CEX, font = 4,col=COL)
  
  text(485,y,format(mean(S[,1]/10),nsmall=1),adj=c(0.75,0),
       family="mono", cex=CEX, font = 4,col=COL)
  
  text(460,y,format(mean(S[,1]),nsmall=1),adj=c(0.75,0),
       family="mono", cex=CEX, font = 4,col=COL)
  ...
  y = 1.5*dy
  text(485,y,
       format(round(sd(S[,1]/10),1),nsmall=1),
       adj=c(0.75,0),
       family="mono", cex=CEX, font = 4,col=COL)
