...
10. Statistically speaking, why  is height a more sensitive distinguisher/separator of the sexes? so? _Hint_: how far apart are the mean heights (a) in cms (b) as a percentage of the  SD of the individuals of a given sex? What are the corresponding perecenatges in the case of birthweights? adult weights? What we are fetting at here is the **signal-to-noise ratio** or **Effect Size**
$$ \frac{Signal}{Noise} = \frac{\mu_1 - \mu_2}{\sigma}.$$ 

11. In 2001, when it came to distinguishing same-sex panels from opposite-sex panels of **adult heights**, most of the students in 2001 **were able** to [correctly identify the opposite-sex panels](http://www.medicine.mcgill.ca/epidemiology/hanley/c607/ch06/telling_sexes_apart.pdf#page=2), with only a few mistaking the same-sex panels for opposite-sex ones [we are in charge of controlling the latter errors, whereas (with $n$ fixed)

12. Biologically speaking, why is height is a more sensitive distinguisher/separator of the sexes?  _Nature_ versus _Nurture_?
