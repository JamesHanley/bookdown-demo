...
The **'statistical' objective** of this exercise is to learn some of the probability laws that which random processes by seeing how frequently certain events occur  
...
From here https://www.cut-the-knot.org/Probability/ChevalierDeMere.shtml

Gamblers in  17th century France used to bet on the event of getting at least one 1 'six' in four rolls of a dice. As a more trying variation, two die were rolled 24 times with a bet on having at least one double six. Chevalier de Méré who expected a couple of aces to turn up in 24 double rolls with the frequency of an ace in 4 single rolls. However, he lost consistently.


Simulate a large number of each of these games, and estimate the probability of getting (a) at least one ace in four rolls of a dice  (b) at least one "double ace" when a pair of dice is thrown 24 times
