...
The **'computing' objective** is to learn how to use `R` to evaluate probabilities by (Monte Carlo) simulation. `R` Functions/structures used include `sample`, `matrix`, `apply`, `paste`, `cumprod` (cumulative product) 
...
1. **Pooled Blood** [variation on an exercise from Chapter 3 of Colton's 1974 book  Statistics in Medicine]  
...
2. **Life Tables [1990]** The following [conditional] probabilities are taken from the
...
4. **Duplicate Numbers** [mini-version of 'the birthday problem']  
